...
const posteosGet = async (req, res) => {
    try {
        ...
        res.status(400).json({ msg: 'Hubo un error al obtener los posteos de usuarios, contactar a soporte.'});
    }
}
...
const posteoGet = async ( req, res) => {
    try {
        ...
        res.status(400).json({ msg: 'Hubo un error al obtener el posteo por ID, contactar a soporte.'});
    }
}
...
const posteosUsuarioGet = async ( req, res) => {
    try {
        ...
        res.status(400).json({ msg: 'Hubo un error al obtener los Posteos, contactar a soporte.'});
    }
}
...
const posteosPut = async (req, res) => {
    try {
        ...
        res.status(400).json({ msg: 'Hubo un error al actualizar el Posteo, contactar a soporte.'});
    }
}
...
const posteosDelete = async (req, res) => {
    try {
        ...
        res.status(400).json({ msg: 'Hubo un error al eliminar el Posteo, contactar a soporte.'});
    }
}
...
// Obtener la cantidad de likes de una publicacion
...
// Obtener los usuarios que le dieron like a una publicacion mediante su id de posteo
const getLikesUsuariosPosteos = async (req, res) => {
    try {
        // obtener ID de publicacion
        const { id } = req.params;
        // buscar en la BD
